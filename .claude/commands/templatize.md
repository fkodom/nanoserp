...
7. Set up branch protections for the `main` branch:
    ```bash
    ...
    ```
    This requires CI status checks to pass before merging, but allows admins to bypass all rules (useful for solo projects).
